...
fn main() {
    ...
    let result: i64 = match (args.day, args.part) {
        ...
        (12, 1) => day12::part_one(input),
        (12, 2) => day12::part_two(input),
        (13, 1) => day13::part_one(input),
        (13, 2) => day13::part_two(input),
        (14, 1) => day14::part_one(input),
        (14, 2) => day14::part_two(input),
        (15, 1) => day15::part_one(input),
        (15, 2) => day15::part_two(input),
        (16, 1) => day16::part_one(input),
        (16, 2) => day16::part_two(input),
        (17, 1) => day17::part_one(input),
        (18, 1) => day18::part_one(input),
        (18, 2) => day18::part_two(input),
        (19, 1) => day19::part_one(input),
        (19, 2) => day19::part_two(input),
