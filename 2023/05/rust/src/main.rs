...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    soil_to_fertilizer_input
        ...
        .skip(1)
        .for_each(|l| {
            println!("soil_to_fertilizer_line {}", l);
    ...
    fertilizer_to_water_input
        ...
        .skip(1)
        .for_each(|l| {
            println!("fertilizer_to_water_line {}", l);
    ...
    temp_to_humidity_input
        ...
        .skip(1)
        .for_each(|l| {
            println!("temp_to_humidity_line {}", l);
    ...
    humidity_to_location_input
        ...
        .skip(1)
        .for_each(|l| {
            println!("humidity_to_location_line {}", l);
